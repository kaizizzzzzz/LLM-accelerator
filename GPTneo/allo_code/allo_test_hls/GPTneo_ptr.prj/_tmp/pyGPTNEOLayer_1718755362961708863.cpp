...
void pyGPTNEOLayer_1718755362961708863(
...
PYBIND11_MODULE(pyGPTNEOLayer_1718755362961708863, m) {
  m.def("GPTNEOLayer", &pyGPTNEOLayer_1718755362961708863, "GPTNEOLayer wrapper");
}
