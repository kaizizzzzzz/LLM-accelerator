...
int main(int argc, char** argv) {
    ...
    std::vector<float, aligned_allocator<float> > source_in1(768);
    ...
    std::vector<float, aligned_allocator<float> > source_in4(589824);
    ...
    std::vector<float, aligned_allocator<float> > source_in6(589824);
    size_t size_bytes_in7 = sizeof(float) * 768;
    std::vector<float, aligned_allocator<float> > source_in7(768);
    ...
    std::vector<float, aligned_allocator<float> > source_in9(768);
    size_t size_bytes_in10 = sizeof(float) * 2359296;
    std::vector<float, aligned_allocator<float> > source_in10(2359296);
    size_t size_bytes_in11 = sizeof(float) * 3072;
    std::vector<float, aligned_allocator<float> > source_in11(3072);
    size_t size_bytes_in12 = sizeof(float) * 2359296;
    std::vector<float, aligned_allocator<float> > source_in12(2359296);
