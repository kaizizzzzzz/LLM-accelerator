...
COMMON_REPO ?= $(shell bash -c 'export MK_PATH=$(MK_PATH); echo $${MK_PATH%GPTneo/allo_code/allo_test_hls/*}')
...
ifeq ($(TARGET),$(filter $(TARGET),sw_emu hw_emu))
	...
	$(ECHO) '$(EXECUTABLE) masked_casual_dot_product_attention.xclbin' >> run_app.sh
